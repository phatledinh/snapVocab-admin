        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-3.5">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="VD: Cấp phát bù sự cố AI Camera / Thu hồi gian lận bot / Đã duyệt qua Ticket #OPS-8912..."
          ...
          <div className="flex items-center justify-end gap-2 pt-2 border-t border-border">
            <button
              type="button"
              onClick={handleClose}
              className="px-3 py-1.5 rounded-lg border border-border bg-surface hover:bg-surface-subtle text-xs font-medium text-text-muted hover:text-text transition-colors"
            >
              Hủy bỏ
            </button>
            <button
